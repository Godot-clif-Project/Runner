...
const HITS = {
	"off_hi_r_light" : {
		"damage" : 30, "knockback" : Vector2(0, -5), "is_directional" : true, "hitstop" : 0.1,
#		"tiredness" : 2, "sp_gain" : 10,
#		"guard_break" : true, "pick_up" : true, "launcher" :  true,
#		"type" : Hit.HIT_TYPE.SWORD, "visual_effect" : Hit.VISUAL_EFFECTS.SLASH,
		},
	"off_hi_r_heavy" : {
		"damage" : 100, "knockback" : Vector2(0, -8), "is_directional" : true, "hitstop" : 0.175,
#		"tiredness" : 2, "hitstop" : 0.25, "sp_gain" : 10,
#		"guard_break" : true, "pick_up" : true, "launcher" :  true,
#		"type" : Hit.HIT_TYPE.SWORD, "visual_effect" : Hit.VISUAL_EFFECTS.SLASH
		},
	"def_hi_light" : {
